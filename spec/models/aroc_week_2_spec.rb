...
# ----------------------
  ...
  it '9. finds orders for a user' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    orders_of_user_3 = Order.joins(:user)
  ...
  it '12. should return all items except items 2, 5 and 6' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # items = Item.except('items.id != ? AND items.id != ? AND items.id != ?', @item_2.id, @item_5.id, @item_6.id)
    # ------------------------------------------------------------
